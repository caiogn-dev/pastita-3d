    ...
    const fetchOrderDetails = async () => {
      if (orderNumber) {
        try {
          ...
          try {
            const response = await api.get(`/pastita/pedidos/${orderNumber}/`);
            setOrderDetails(response.data);
            
            // Get WhatsApp URL
            const whatsappResponse = await api.get(`/pastita/pedidos/${orderNumber}/whatsapp/`);
            setWhatsappUrl(whatsappResponse.data.whatsapp_url);
          } catch {
